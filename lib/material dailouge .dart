...
import 'MATERIALDAILOUGUE.dart';


void main(){
  runApp(MaterialApp(title: 'Material design dailougue',
  theme: ThemeData(textTheme: GoogleFonts.montserratTextTheme(
    Theme.of(context as BuildContext).textTheme,
  ),primarySwatch: Colors.teal),
    home: SafeArea(child: Scaffold(backgroundColor: Colors.green,
    appBar: AppBar(title: Text("Material design Dailouges"),),
    body: TestPage(),),)
    ,));
}
class materialdailougue extends StatelessWidget{
  @override
