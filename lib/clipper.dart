...
class clipperwidget extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(title: Text("Clipper widget"),backgroundColor: Colors.teal,),
    body: ListView(children: [ClipPath(clipper: WaveClipperOne(flip: true,reverse: true),
      child: Container(height: 130,color: Colors.red,child: Center(child:Text("WaveClipperTwo(flip:true,reverse: true "),),
      ),)],),);
  }
