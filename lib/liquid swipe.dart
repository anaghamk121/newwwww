...
class _WithBuilder extends State<WithBuilder> {
  ...
  List<ItemData> data = [
    ItemData(Colors.blue, "images/cat.png", "Hi", "It's Me", "Sahdeep"),
    ItemData(Colors.deepPurpleAccent, "images/cat.png", "Take a", "Look At",
        "Liquid Swipe"),
    ItemData(Colors.green, "images/cat.png", "Liked?", "Fork!", "Give Star!"),
    ItemData(Colors.yellow, "images/cat.png", "Can be", "Used for",
        "Onboarding design"),
    ItemData(
        Colors.pink, "images/cat.png", "Example", "of a page", "with Gesture"),
    ItemData(Colors.red, "images/cat.png", "Do", "try it", "Thank you"),
  ];
