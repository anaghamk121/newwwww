...
class HomePost extends StatelessWidget {
  HomeController controller = Get.put(
      HomeController()); //controller data ne vilikm,post lek aan edth veknneth
// constant aayt ullathine vere class aayt edth vekam( colors, constsnackbar)
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: MyColors.bgcolor,
      appBar: buildAppBar(), //normal appbar ne function vilich
      ...
      body: Obx(
        () => SizedBox(
            ...
            child: controller
                    .isInternetConnected.value //connectred aano check cheyan
  ...
  AppBar buildAppBar() {
    //normal appbar ne function vilich
    return AppBar(
      ...
      child: Column(
        ...
        children: [
          SizedBox(
            height: 250,
            width: 250,
            child: Lottie.asset("assets/animation/45721-no-internet.json"),
          ),
          MaterialButton(
